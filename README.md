...
## Features
- **203** curated questions across 4 subjects, each in its **correct language** with a **worked explanation**.
...
- **Milestone mini‑games** — a *different* game each milestone, harder each time (7 in rotation):
  ⚡ Speed Math · 🧩 Memory Match · 🌠 Star Catcher · 🔤 Word Scramble · 🔢 Sequence Sprint · 📚 Meaning Match · ⚡ True/False Blitz.
- Practice by subject, **Mixed** challenge, **Timed Mock**, and **Review mistakes** modes; study notes per subject.
